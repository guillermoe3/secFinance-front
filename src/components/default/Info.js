            ...
            <Box sx={{ height: "30vh", display: "flex", flexDirection: "row", justifyContent: 'center', alignItems: "center"}}> 
             ...
             <Box sx={{width: "20vw"}}>
                ...
                "&:hover": {
                    ...
                    <SecurityIcon sx={{fontSize: "9vh",display:"flex", justifiy: "center", alignItems: "center", m:1, 
                    "&:hover": {
                    fontSize: "12vh",
                }}}/>
                    <Box sx={{display:"flex", justifiy: "center", alignItems: "center", m:1}}>Threat Intelligence
                    </Box>
                </Box>
                </Box>
